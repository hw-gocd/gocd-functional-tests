...
public class SSLHelperTest extends TestCase {
	...
	public void xtestSSLCommand() {
        ...
        assertEquals("keytool.exe -genkey -alias www.sahipro.com -keypass pwd -storepass pwd -keyalg RSA -keystore filekarasta -dname \"CN=www.sahipro.com, OU=Sahi, O=Sahi, L=Bangalore, S=Karnataka, C=IN\"" , helper.getPrintableSSLCommand(helper.getSSLCommand("www.sahipro.com", "filekarasta", "pwd", "keytool.exe")).trim());
    }
