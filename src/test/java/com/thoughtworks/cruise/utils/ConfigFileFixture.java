...
import static com.thoughtworks.cruise.utils.Pop3MailClient.SMTP_ADMIN;
import static com.thoughtworks.cruise.utils.Pop3MailClient.SMTP_FROM;
import static com.thoughtworks.cruise.utils.Pop3MailClient.SMTP_HOSTNAME;
import static com.thoughtworks.cruise.utils.Pop3MailClient.SMTP_PASSWORD;
import static com.thoughtworks.cruise.utils.Pop3MailClient.SMTP_PORT;
import static com.thoughtworks.cruise.utils.Pop3MailClient.SMTP_TLS;
import static com.thoughtworks.cruise.utils.Pop3MailClient.SMTP_USERNAME;
...
import static com.thoughtworks.cruise.utils.configfile.MaterialTags.anyP4Tag;
import static com.thoughtworks.cruise.utils.configfile.MaterialTags.materialsTag;
import static com.thoughtworks.cruise.utils.configfile.MaterialTags.p4Tag;
import static com.thoughtworks.cruise.utils.configfile.PipelineTags.approvalTag;
import static com.thoughtworks.cruise.utils.configfile.PipelineTags.authTag;
import static com.thoughtworks.cruise.utils.configfile.PipelineTags.jobTag;
import static com.thoughtworks.cruise.utils.configfile.PipelineTags.pipelineTag;
import static com.thoughtworks.cruise.utils.configfile.PipelineTags.propertiesTag;
import static com.thoughtworks.cruise.utils.configfile.PipelineTags.propertyTag;
import static com.thoughtworks.cruise.utils.configfile.PipelineTags.stageTag;
import static com.thoughtworks.cruise.utils.configfile.PipelineTags.trackingTool;
...
import com.thoughtworks.cruise.utils.configfile.CruiseConfigTag;
import com.thoughtworks.cruise.utils.configfile.CruiseConfigUtil;
import com.thoughtworks.cruise.utils.configfile.MaterialTags;
import com.thoughtworks.cruise.utils.configfile.PipelineTags;
import com.thoughtworks.cruise.utils.configfile.SimpleCruiseConfigTag;
